...
searchHidden: "false"
---
Grafana is a tool that allows you to build dashboards to visualize data.  I haven't dove too deep into the full capabilities yet, but I wanted a way to display the weather data from my database without reinventing the wheel and building dashboards manually myself.
...
I need to change my default time view for the dashboard to show the next seven days, as that is the time period the forecasts are scraping by entering "now\d" to "now+7d\d".  Now I've got basic time series graphs showing me hourly forecasts pulled from NWS for both my home and work zones.

##### Some time later...
Over time after the initial setup and configuration of Timescale and Grafana I've added more views and dashboards.  I've found digging into the details that I like Grafana a lot, you can make a lot of customizations to the panels, and I really still haven't dug super deep yet doing things like configuring alerts.  But over time, here are some of the things I've used Timescale and Grafana to create:
